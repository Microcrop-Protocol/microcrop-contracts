...
import {RiskPoolFactoryV2Upgradeable} from "../src/RiskPoolFactoryV2Upgradeable.sol";
...
/**
 * @title RiskPoolFactoryV2UpgradeableTest
 * @dev Tests for the upgradeable factory contract
 */
contract RiskPoolFactoryV2UpgradeableTest is Test {
    RiskPoolFactoryV2Upgradeable public factoryImplementation;
    RiskPoolFactoryV2Upgradeable public factory;
    RiskPoolV2Upgradeable public poolImplementation;
    ...
    function setUp() public {
        ...
        factoryImplementation = new RiskPoolFactoryV2Upgradeable();
        poolImplementation = new RiskPoolV2Upgradeable();

        // Deploy factory proxy
        bytes memory initData = abi.encodeWithSelector(
            RiskPoolFactoryV2Upgradeable.initialize.selector,
            address(usdc),
            treasury,
            protocolTreasury,
        ...
        factory = RiskPoolFactoryV2Upgradeable(address(proxy));
    ...
    function test_CreatePublicPool() public {
        RiskPoolFactoryV2Upgradeable.PublicPoolParams memory params = RiskPoolFactoryV2Upgradeable.PublicPoolParams({
        ...
        RiskPoolV2Upgradeable pool = RiskPoolV2Upgradeable(poolAddress);
    ...
    function test_CreatePublicPool_EmitsEvent() public {
        ...
        emit RiskPoolFactoryV2Upgradeable.PoolCreated(
            1,
            address(0), // We don't know the address yet
            RiskPoolV2Upgradeable.PoolType.PUBLIC,
            "Kenya Maize Pool",
            "mcMAIZE",
            address(0)
        );
    ...
    function test_CreatePublicPool_InvalidTargetCapital_Reverts() public {
        ...
        vm.expectRevert(RiskPoolFactoryV2Upgradeable.InvalidTargetCapital.selector);
        factory.createPublicPool(params);
    }
    ...
    function test_CreatePrivatePool() public {
        RiskPoolFactoryV2Upgradeable.PrivatePoolParams memory params = RiskPoolFactoryV2Upgradeable.PrivatePoolParams({
    ...
    function test_CreatePrivatePool_InvalidMinDeposit_Reverts() public {
        ...
        vm.expectRevert(RiskPoolFactoryV2Upgradeable.InvalidMinDeposit.selector);
    ...
    function test_CreateMutualPool() public {
        RiskPoolFactoryV2Upgradeable.MutualPoolParams memory params = RiskPoolFactoryV2Upgradeable.MutualPoolParams({
    ...
    function test_GetPoolsByType() public {
        ...
        factory.createPublicPool(RiskPoolFactoryV2Upgradeable.PublicPoolParams({
            name: "Public Pool",
            symbol: "PUB",
            coverageType: RiskPoolV2Upgradeable.CoverageType.DROUGHT,
            region: "Kenya",
        ...
        factory.createPrivatePool(RiskPoolFactoryV2Upgradeable.PrivatePoolParams({
            name: "Private Pool",
            symbol: "PRIV",
            coverageType: RiskPoolV2Upgradeable.CoverageType.DROUGHT,
            region: "East Africa",
        ...
        factory.createMutualPool(RiskPoolFactoryV2Upgradeable.MutualPoolParams({
            name: "Mutual Pool",
            symbol: "MUT",
            coverageType: RiskPoolV2Upgradeable.CoverageType.FLOOD,
            region: "West Kenya",
        ...
        address[] memory publicPools = factory.getPoolsByType(RiskPoolV2Upgradeable.PoolType.PUBLIC);
        address[] memory privatePools = factory.getPoolsByType(RiskPoolV2Upgradeable.PoolType.PRIVATE);
        address[] memory mutualPools = factory.getPoolsByType(RiskPoolV2Upgradeable.PoolType.MUTUAL);
    ...
    function test_GetPoolMetadata() public {
        ...
        RiskPoolFactoryV2Upgradeable.PoolMetadata memory metadata = factory.getPoolMetadata(1);

        assertEq(metadata.poolId, 1);
        assertEq(metadata.name, "Kenya Maize Pool");
        assertEq(metadata.region, "Kenya");
        assertEq(uint256(metadata.poolType), uint256(RiskPoolV2Upgradeable.PoolType.PUBLIC));
    }

    function test_GetPoolMetadata_NotFound_Reverts() public {
        vm.expectRevert(RiskPoolFactoryV2Upgradeable.PoolNotFound.selector);
    ...
    function test_Upgrade_OnlyUpgrader() public {
        RiskPoolFactoryV2Upgradeable newImpl = new RiskPoolFactoryV2Upgradeable();
    ...
    function test_CreatedPool_AcceptsDeposits() public {
        address poolAddress = factory.createPublicPool(RiskPoolFactoryV2Upgradeable.PublicPoolParams({
            name: "Kenya Maize Pool",
            symbol: "mcMAIZE",
            coverageType: RiskPoolV2Upgradeable.CoverageType.DROUGHT,
            region: "Kenya",
